...
class Config_Task2:
    ...
    data_path = "/mnt/hdd2/task2/memsam/dataset_memsam"
    ...
    train_split = "custom_train1_filenames.txt"
    val_split = "custom_val1_filenames.txt"
    test_split = "custom_test1_filenames.txt"
